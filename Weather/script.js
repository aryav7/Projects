...
function showWeaterReport(weather) {
    ...
    <div class="day-details">
        <div class="basic"><i class="${getIconClass(weather.weather[0].main)}"></i> Feels like - ${weather.main.feels_like}&deg;C</div>
        <div class="basic"><i class="fa-solid fa-droplet"></i> Humidity - ${weather.main.humidity}%  </div>
        <div class="basic"><i class="fa-solid fa-temperature-full"></i> Pressure - ${weather.main.pressure} mb </div>
        <div class="basic"><i class="fa-solid fa-wind"></i> Wind - ${weather.wind.speed} KMPH</div>
    </div>
    `;
